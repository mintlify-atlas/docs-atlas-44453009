...
<CodeGroup>
```bash cURL
curl -X POST https://api.techstore.com/api/auth/register \
...
const response = await fetch('https://api.techstore.com/api/auth/register', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.techstore.com/api/auth/register',
    json={
        'nombre': 'John',
        'apellido': 'Doe',
        'email': 'john.doe@example.com',
...
<CodeGroup>
```bash cURL
curl -X GET "https://api.techstore.com/api/auth/verificar?token=a1b2c3d4-e5f6-7890-abcd-ef1234567890"
```

```javascript JavaScript
// This is typically accessed via email link click
window.location.href = 'https://api.techstore.com/api/auth/verificar?token=a1b2c3d4-e5f6-7890-abcd-ef1234567890';
```
...
response = requests.get(
    'https://api.techstore.com/api/auth/verificar',
...
<CodeGroup>
```bash cURL
curl -X POST https://api.techstore.com/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{
    "email": "john.doe@example.com",
    "password": "securePassword123"
...
```javascript JavaScript
const response = await fetch('https://api.techstore.com/api/auth/login', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json'
  },
...
response = requests.post(
    'https://api.techstore.com/api/auth/login',
    json={
        'email': 'john.doe@example.com',
        'password': 'securePassword123'
    }
...
<CodeGroup>
```bash cURL
curl -X POST https://api.techstore.com/api/auth/forgot-password \
  -H "Content-Type: application/json" \
  -d '{
    "email": "john.doe@example.com"
  }'
...
```javascript JavaScript
const response = await fetch('https://api.techstore.com/api/auth/forgot-password', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json'
  },
...
response = requests.post(
    'https://api.techstore.com/api/auth/forgot-password',
    json={
        'email': 'john.doe@example.com'
    }
)
...
<CodeGroup>
```bash cURL
curl -X POST https://api.techstore.com/api/auth/reset-password \
  -H "Content-Type: application/json" \
  -d '{
...
```javascript JavaScript
const response = await fetch('https://api.techstore.com/api/auth/reset-password', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json'
  },
...
response = requests.post(
    'https://api.techstore.com/api/auth/reset-password',
    json={
        'token': 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
        'nuevaPassword': 'newSecurePassword456'
    }
